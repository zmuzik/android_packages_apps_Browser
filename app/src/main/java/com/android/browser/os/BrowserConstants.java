...
package com.android.browser.os;
...
public class BrowserConstants {
    ...
    /**
     * The name of extra data when starting BrowserConstants with ACTION_VIEW or
     * ACTION_SEARCH intent.
     * <p>
     * The value should be an integer between 0 and 1000. If not set or set to
     * 0, the BrowserConstants will use default. If set to 100, the BrowserConstants will start
     * with 100%.
     */
    public static final String INITIAL_ZOOM_LEVEL = "browser.initialZoomLevel";

    /**
     * The name of the extra data when starting the BrowserConstants from another
     * application.
     * <p>
     * The value is a unique identification string that will be used to
     * identify the calling application. The BrowserConstants will attempt to reuse the
     * same window each time the application launches the BrowserConstants with the same
     * identifier.
     */
     ...
     * BrowserConstants, use this to access the screenshot.
     * @hide
     */
     ...
     * BrowserConstants, use this to access the favicon.
     * @hide
     */
